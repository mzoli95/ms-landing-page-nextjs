...
export function ComingSoon() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute top-44 right-[-10rem] h-72 w-72 rounded-full bg-white/5 blur-3xl" />
      ...
      <Container className="relative py-20 sm:py-28">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-base leading-7 text-white/80">
            Dolgozunk az oldalon. Addig is, ha belső rendszert, automatizálást
            vagy riport dashboardot szeretnél, írj nyugodtan emailt.
          </p>

          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <Button href={`mailto:${site.email}`}>Írok emailt</Button>
          ...
          <div className="mt-12 grid gap-4 text-left sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5 text-sm text-white/85">
              <div className="font-semibold text-white">Gyors indulás</div>
              <div className="mt-1 text-white/75">
